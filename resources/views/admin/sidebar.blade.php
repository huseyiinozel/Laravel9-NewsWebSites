<nav class="navbar-default navbar-static-side" role="navigation">
    ...
    <div class="sidebar-collapse">
        ...
        <ul class="nav" id="side-menu">
            ...
            <li class="">
                <a href="{{asset('assets')}}/admin/index.html"><i class="fa fa-dashboard fa-fw"></i>Dashboard</a>
            </li>
            <li>
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li>
                        <a href="{{asset('assets')}}/admin/morris.html">Morris Charts</a>
                    </li>
                </ul>
                <!-- second-level-items -->
            </li>
            <li>
                <a href="{{asset('assets')}}/admin/timeline.html"><i class="fa fa-flask fa-fw"></i>Timeline</a>
            </li>
            <li>
